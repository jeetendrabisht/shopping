...
import { getCartItem, getCartOpen } from '../actions';
...
class Cart extends React.PureComponent {
    ...
    render() {
        ...
        return <div className="content-cart cart-mask">
            ...
            {(cartData && cartData.length) ? <div className="layer-3">
                ...
                <button type="button" className="cart-button">
                    <span onClick={() => this.props.closeCart()}>Start Shopping
