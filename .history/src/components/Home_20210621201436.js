...
// import img from "../static/images/category/bakery.png";
let img = require("../static/images/category/bakery.png");
            ...
            <div className="home-display">
                {category.map(categoryData => {
                    return <div className="home-category" key={categoryData.id}>
                        ...
                        <img src={require(".."+categoryData.imageUrl)} alt="product_image" />
                    </div>
                })}
            </div>
        </div>
