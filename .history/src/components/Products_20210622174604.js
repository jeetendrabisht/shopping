...
class Products extends React.PureComponent {
    ...
    handleBuyNow() {
        ...
        const userType = JSON.parse(sessionStorage.getItem(Object.keys(sessionStorage)[0])).userType;
    ...
    filtering(item) {
        return <div className="products-data" key={item.id}>
            ...
            <div className="price-buy-button">
                ...
                <button type="button" onClick={this.handleBuyNow}>Buy Now</button>
            </div>
    ...
    render() {
        ...
        const { flag, filteredData, homeCategoryId } = this.state;
