...
class Products extends React.PureComponent {
    ...
    onClickCategory(categoryId) {
        ...
        this.setState({ filteredData: filterData, flag: true, categorySelected: true });
    }
        ...
        return <div className={screenWidth <= 600 ? "main-content-product-mobile" : "main-content-product"}>
            {screenWidth <= 600 ?
                ...
                : <div className="category">
                    {category.map(categoryData => {
                        return <div className={(categorySelected ? "selected-category" : "") + " products-category"} key={categoryData.id}>
