...
import { getProductsAPI, getCategory, getCartItem, getCartOpen } from '../actions';
...
class Products extends React.PureComponent {
    ...
    render() {
        const { items, category, cartOpenHere } = this.props;
        console.log("cartOpenHere is  ", cartOpenHere);
        const { flag, filteredData, homeCategoryId, screenWidth, categorySelected } = this.state;
