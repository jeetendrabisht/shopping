        ...
        <div className="right-content-register">
            <form>
                <fieldset>
                    ...
                    <p>
                    {fnameVisible && <label for="fname">First Name</label>}
                    <input type="text" id="fname" name="fname" placeholder="First Name" onFocus={() => this.setFnameVisible(!fnameVisible)}></input>
                    </p>
                    <p>
