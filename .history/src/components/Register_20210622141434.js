        ...
        <div className="right-content-register">
            <form>
                <fieldset>
                    ...
                    <input type="password" id="password" name="pwd" placeholder="Password" value={userData.pwd} onFocus={() => setPassVisible(true)} onBlur={() => setPassVisible(false)} onChange={handleInput}></input>
                    </p>
                    {/* CONFIRM PASSWORD */}
                    <p>
                    <label className={cPassVisible ? "cPass-visible": "cPass-notVisible"} htmlFor="confirmPassword">Confirm Password</label>
                    <input type="password" id="confirmPassword" name="cPwd" placeholder="Confirm Password" value={userData.cPwd} onFocus={() => setCPassVisible(true)} onBlur={() => setCPassVisible(false)} onChange={handleInput}></input>
                    </p>
